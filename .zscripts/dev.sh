...
# No cleanup trap - let Next.js dev server persist after script exits
# The container's init system (tini) manages process lifecycle
...
log_step_start "Starting Next.js dev server (webpack mode)"
echo "[BUN] Starting development server with webpack (Turbopack unstable in container)..."
